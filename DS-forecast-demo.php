...
<title>DarkSky Forecast script - Demo Page</title>
<style type="text/css">
/*--------------------------------------------------
  tabbertab 
  --------------------------------------------------*/
...
<?php
  ...
  $SITE = array();
	global $SITE;
	$SITE['DSAPIkey'] = 'specify-for-standalone-use-here'; // use this only for standalone 
	$SITE['charset'] = 'UTF-8';
	$SITE['lang'] = 'en';
	$SITE['DSshowUnitsAs'] = 'ca';
...
$SITE['WULanguages'] = array ( // for WeatherUnderground forecast supported languages
  ...
  print "<h1>Demo page for DS-forecast.php</h1>\n";
...
?>
<hr />
<p>See the <a href="https://github.com/ktrue/Weather-PHP/tree/master/forecast/DarkSky">script page</a> for documentation and downloads.</p>
</body>
</html>